...
@export var overlap_shift_direction: int # (CFInt.OverlapShiftDirection)
# In case of multiple CardContainers using the same anchor placement
# specifies which container should be displaced more.
@export var index_shift_priority: int # (CFInt.IndexShiftPriority)
...
# Returns the class name "CardContainer"
func get_card_container_class():
